...
import { TAILWIND_500_HEX, UI_PRIMARY_COLORS, type UiPrimaryColor } from '@/ui/theme/uiTokens';

export const UI_PRIMARY_SHADES = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950] as const;
...
export function primaryPaletteCssProperties(color: UiPrimaryColor): Record<string, string> {
