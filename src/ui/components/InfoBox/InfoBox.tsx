...
const bodyCompactClass =
  "mx-0.5 mb-0.5 flex min-h-4 flex-1 items-center justify-center";
  ...
  return (
    <NeoSurface
      ...
      faceClassName={[
        ...
        compact ? "py-0.5" : "py-1 lg:py-1.5 xl:py-2",
      ].join(" ")}
    >
...
export function InfoBoxLegValue({ current, total, compact = false }: InfoBoxLegValueProps) {
  ...
  return (
    <div
      ...
      aria-label={`Leg ${current} of ${total}`}
    >
