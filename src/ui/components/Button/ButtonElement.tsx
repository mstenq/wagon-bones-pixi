...
export function ButtonElement({
  ...
  const faceClassName = [
    ...
    "flex min-h-6 w-full min-w-0 items-center justify-center px-1.5 py-0.5 text-xs lg:min-h-8 lg:px-2 lg:py-1 lg:text-sm xl:min-h-12 xl:px-4 xl:py-2.5 xl:text-[1.4rem]",
