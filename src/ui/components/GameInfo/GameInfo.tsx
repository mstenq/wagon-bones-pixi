...
function GameInfoProfessionModifiersRow({
  ...
  return (
    <div className={['flex w-full min-w-0 items-stretch gap-0.5 xl:gap-2', className].filter(Boolean).join(' ')}>
  ...
  if (displayMode === 'portrait') {
    return (
      <div className="flex flex-col gap-0.5 lg:gap-1 xl:gap-2">
        ...
        <GameInfoActionButtons direction="row" onRunInfoClick={onRunInfoClick} onOptionsClick={onOptionsClick} />
      </div>
    );
  }
