...
import { generateRandomEquipment, getItemAuraById } from './ItemsSystem';
...
import type { TrailTagDef, TrailTagInstance, TagCategory, RoundSkipPreviewMeta } from '../data/trail_tags';
